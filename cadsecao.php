...
<html lang="en">
    ...
    <body>
        <h2 style="text-align: center">Cadastro de seção</h2> 
       ...
       <ul style="list-style-type:none;">
        ...
        <form method="post" action="lojacontroller.php?acao=inssecao">
            <table>
                <tr>
                    <td><label>Nome : </label> <input type="text" name="nome" size="45" /></td>
